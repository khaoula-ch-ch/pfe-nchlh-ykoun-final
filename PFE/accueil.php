...
<body>
    ...
    <div class="naVbar"><br>
        ...
        <div class="row">
        <div class="col">
        <h1> <center><img src="logo.png" width="300" height="200"></center></h1></div>
        <div class="col">
            ...
            <div class="card card2">
                <h3><a href="valider.php">valider les courriers</a></h3>
            
              </div>
              <br>
              <div class="card card3">
                <h3><a href="courrierarr.php">Courrier arrivee</a></h3>
              </div>
              <div class="card card4">
                <h3><a href="courrierdep.php">courrier depart</a> </h3>
              </div>
        </div>
        </div>
    </div>
