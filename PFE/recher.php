...
$sql = "SELECT * FROM `courrierarrive` WHERE ( envoyerpar = '$str' OR ref='$str' OR distination='$str' OR sousdistination='$str' OR objet='$str') AND (distination = '$emp_name' OR sousdistination  = '$emp_name' OR envoyerpar = '$emp_name' )";
